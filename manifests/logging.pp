...
class rally::logging(
  ...
  $log_file                      = '/var/log/rally/rally.log',
  ...
  $use_syslog_real   = pick($::rally::use_syslog, $use_syslog)
  $use_stderr_real   = pick($::rally::use_stderr, $use_stderr)
  $log_facility_real = pick($::rally::log_facility, $log_facility)
  $log_dir_real      = pick($::rally::log_dir, $log_dir)
  $log_file_real     = pick($::rally::log_file, $log_file)
  $verbose_real      = pick($::rally::verbose, $verbose)
  $debug_real        = pick($::rally::debug, $debug)
  $rally_debug_real  = pick($::rally::rally_debug, $rally_debug)
  ...
  rally_config {
    ...
    'DEFAULT/rally_debug' :                   value => $rally_debug_real;
  }
